...
*/
		...
		// ВНИМАНИЕ! Последний аргумент отсутствует в нативном методе getCategoryTree() и добален здесь для того, чтобы снять лимит вывода данных. В случае переустановки VirtueMart - добавить заново как ",$unlimited = false"
