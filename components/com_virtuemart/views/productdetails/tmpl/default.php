    ...
    <div class="o_o">
      ...
      <span class="span_o_o">
          ...
          <span class="bold span_o_o">
   		      <a href="index.php?option=com_auction2013&<?php echo JRoute::_(AuctionStuff::$auction_list_common_link . $this->product->auction_number . '&Itemid=' . $Itemid);?>"><?=$this->product->auction_number?></a>
          </span>
    </div>				
    <div class="o_o">
