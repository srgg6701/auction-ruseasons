...
<link href="<?=JUri::root()?>_temp/thumbs_files/style.css" rel="stylesheet" type="text/css">
<link href="<?=JUri::root()?>_temp/thumbs_files/magiczoomplus.css" rel="stylesheet" type="text/css" media="screen">
<script src="<?=JUri::root()?>_temp/thumbs_files/magiczoomplus.js" type="text/javascript"></script>
<!--<script src="./thumbs_files/jquery-1.2.6.js" type="text/javascript"></script>-->

<script type="text/javascript" src="<?=JUri::root()?>_temp/thumbs_files/prototype.js"></script>
<script type="text/javascript" src="<?=JUri::root()?>_temp/thumbs_files/main.js"></script>
